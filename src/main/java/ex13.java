...
public class ex13 {
    public static void main(String[] args){
        ...
        int n = Integer.parseInt(cursor.nextLine());

        double investment = p * Math.pow((1 + rate/n),(t*n));
        investment = Math.round(investment * 100.0) / 100.0;
        System.out.println("$" + p + " invested at " + r + "% for " + t + " years compounded " + n + " times per year is $" + investment + ".");
    }
}
